...
class Pila {
    ...
    eliminar() {
        if (this.Top !== -1) {
            console.log("Dato a eliminar: " + this.Pila[this.Top]);
            this.Pila[this.Top] = undefined;
            this.Top--;
        } else {
...
const main = () => {
    ...
    const loop = () => {
        console.clear();
        console.log("PILA Números Flotantes");
        ...
        rl.question("Escriba qué opción quiere: ", (opc) => {
            switch (opc) {
                ...
                case 'b':
                    ...
                    rl.question("\nIngrese el valor que desea agregar: ", (elemento) => {
                        pila.insertar(Number(elemento));
                        loop();
                    });
                    break;
                ...
                case 'e':
                    ...
                    rl.question("Ingrese el valor a buscar: ", (num) => {
                        pila.buscar(Number(num));
                        loop();
                    });
                    break;
