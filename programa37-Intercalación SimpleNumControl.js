class InterSimple {
    constructor() {
        ...
        this.intercambios = 0;
        this.pasadas = 0;
        this.C = new Array(50).fill(0);
        this.azar = () => Math.floor(Math.random() * (20219999 - 20210000) + 20210000);
    }

    generar() {
        this.A = new Array(25).fill(0).map(() => this.azar());
        this.B = new Array(25).fill(0).map(() => this.azar());
...
const start = () => {
    ...
    do {
        ...
        console.log("a. Generar vectores A y B.");
