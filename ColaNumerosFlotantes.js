...
const main = () => {
    ...
    const menu = () => {
        ...
        rl.question("\nElije una opción: ", (opc) => {
            switch (opc) {
                case 'a':
                    rl.question("Elija el tamaño de la cola: ", (tamanio) => {
                ...
                case 'd':
                    ...
                    break;
                case 'e':
                    rl.question("Ingrese el dato a buscar: ", (dato) => {
                        cola.busqueda(Number(dato));
                        menu();
                    });
                    break;
                case 'f':
